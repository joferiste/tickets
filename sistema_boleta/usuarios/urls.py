...
urlpatterns = [
    ...
    path('mantenimiento_usuario/', views.mantenimiento_usuario, name='mantenimiento_usuarios'),
    path('mantenimiento/eliminar/', views.eliminar_elemento_usuario, name='eliminar_elemento_usuario'),
]
